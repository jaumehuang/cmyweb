var require = require(['main'], function(main) {
	...
	require(['jquery', 'commom'], function($, commom) {
		...
		$(function() {
			...
			var str = commom.localGetItem('historyRecord1');
			historyList(str);
			//点击确定
		...
		function ClickHostory() {
			...
			$(".hot_list").on("click",'.list_li',function(){
				  ...
				  commom.OpenView('search_list1', $(this).text());
		...
		function DeleteHostry() {
			...
			if (commom.localGetItem('historyRecord1')) {

				commom.localRemoveItem('historyRecord1');
		...
		function getKeywords() {
			...
			if (commom.localGetItem('historyRecord1')) {
				...
				str = str + '|' + $Keywords;
				commom.localSetItem('historyRecord1',str);

			} else {

				commom.localSetItem('historyRecord1',$Keywords);
			};

			commom.OpenView('search_list1', $Keywords);
